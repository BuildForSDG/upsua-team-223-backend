@extends('layouts.app', ['title' => __('Admin user Management')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Admin user management') }}</h3>
                            </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('user.store') }}" autocomplete="off">
                            ...
                            <h6 class="heading-small text-muted mb-4">{{ __('Admin user information') }}</h6>
                            <div class="pl-lg-4">
