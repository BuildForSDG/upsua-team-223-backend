    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center">
          <!-- <h1 class="logo mr-auto"><a href="">upsua</a></h1>-->
          <!-- Uncomment below if you prefer to use an image logo -->
          <a href="" class="logo mr-auto"><img src="{{ asset('argon') }}/img/brand/white.png" alt="" class="img-fluid"></a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
			...
			@else
				<a href="{{ route('register') }}" class="read-more">{{ __('Register') }} <i class="icofont-lock"></i></a>
				<a href="{{ route('login') }}" class="read-more">{{ __('Login') }} <i class="icofont-key"></i></a>
			@endauth
          </div>
        </div>
